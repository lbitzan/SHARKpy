...
def multimodal_analysis_2(df_stacked, path, station=None, stationid=None, bw_factor=0.2, heightpeaks=0.3):
    """
...
def freq_band_analysis_process(catafile,
        ...
        # breakpoint()
        freq, spec_smooth_11, peaks_11, peak_info_dict_11   = multimodal_analysis_2(df_stacked_11, path, station=stationlist[0],bw_factor=bw_factor, heightpeaks=heightpeaks)
        ...
        freq, spec_smooth_04, peaks_04, peak_info_dict_04   = multimodal_analysis_2(df_stacked_04, path, station=stationlist[1], bw_factor=bw_factor, heightpeaks=heightpeaks)
        ...
        freq, spec_smooth_00, peaks_00, peak_info_dict_00   = multimodal_analysis_2(df_stacked_00, path, station=stationlist[2], bw_factor=bw_factor, heightpeaks=heightpeaks)
