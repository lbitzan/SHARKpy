...
def runPlotCatalog(rrange = None):
    '''
    ...
    from kav_init import stationdir, stationid, shifttime, ratiorange, flag_bandedratio, flag_wlvl, flag_group, yoi, moi, doi, hoi, shifttime, ratiorange
    ...
    for imoi in moi:
        ...
        for idoi in doi:
            ...
            # ratiotriggerpeaks,_ = signal.find_peaks(ratio2_1, height=ratiorange, prominence=0.1) # ---> TODO: Try out
            ...
            eventmarker     = fusetriggers(kavatrigger, ratiotrigger, tampl)

            # # --- Implement combined event trigger based on both KaVA Index and amplitude ratio
            # combtrigger, eventmarker     = np.zeros_like(kavatrigger), np.zeros_like(kavatrigger)
            ...
            if plot_flag:
                ...
                markeroffset, yaxlimshark = 20, 2000
